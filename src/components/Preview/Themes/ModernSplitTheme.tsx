      ...
      <div className="flex min-h-0">
        <div className={`w-1/3 ${tokens.sidebarBg} print:bg-white ${tokens.padding} flex flex-col gap-3 border-r border-gray-300`}>
          <div className="border-b border-gray-200 pb-3">
            <h1 className={`${tokens.nameSize} font-bold leading-tight`} style={{ color: tokens.accent }}>
              {personalInfo.fullName || 'Your Name'}
            </h1>
            <p className={`${tokens.titleSize} font-semibold mt-0.5`} style={{ color: tokens.accent }}>
